  ...
  useEffect(() => {
    const loadVismeScript = () => {
      if (!document.querySelector('script[src="https://static-bundles.visme.co/forms/vismeforms-embed.js"]')) {
        ...
        script.async = true;
        script.onload = () => {
          // Hide loader and remove badge after form loads
          setTimeout(() => {
            setFormLoaded(true);
            removeVismeBadge();
          }, 100);
    ...
    // Set up observer to retry if form doesn't load and remove badge
  ...
  return (
    <section className="hummer-contact-section" id="contact" style={{ background: '#f9f9f9' }}>
        ...
        <div className="hummer-contact-grid">
          ...
          >
            <div className="hummer-contact-header">
              <span className="hummer-contact-subtitle" style={{ color: '#8B0000' }}>GET IN TOUCH</span>
              <h2 className="hummer-contact-title" style={{ color: '#333' }}>Hummer Power Solutions</h2>
              <p className="hummer-contact-description" style={{ color: '#555' }}>
            ...
            <div className="hummer-info-items">
              <div className="hummer-info-item">
                <div className="hummer-info-icon" style={{ background: 'rgba(139, 0, 0, 0.1)', borderColor: 'rgba(139, 0, 0, 0.2)' }}>
                ...
                <div className="hummer-info-content">
                  <h4 style={{ color: '#333' }}>Our Location</h4>
                  <p style={{ color: '#555' }}>30/41-D, Hindusthan Complex, Avarampalayam Main Road, Coimbatore-641 006</p>
                </div>
              </div>
              ...
              <div className="hummer-info-item">
                ...
                <div className="hummer-info-content">
                  <h4 style={{ color: '#333' }}>Email Us</h4>
                  <p style={{ color: '#555' }}>sadha30r@gmail.com</p>
                </div>
              </div>
              ...
              <div className="hummer-info-item">
                ...
                <div className="hummer-info-content">
                  <h4 style={{ color: '#333' }}>Call Us</h4>
                  <p style={{ color: '#555' }}>+91 9344850430</p>
                  <p style={{ color: '#555' }}>+91 8807065445</p>
                </div>
              </div>
              ...
              <div className="hummer-info-item">
                ...
                <div className="hummer-info-content">
                  <h4 style={{ color: '#333' }}>Working Hours</h4>
                  <p style={{ color: '#555' }}>Mon-Fri: 9:00 AM - 9:00 PM</p>
                  <p style={{ color: '#555' }}>Sat-Sun: 9:00 AM - 8:00 PM</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            {!formLoaded && (
              <div className="hummer-form-loader" style={{
                position: 'absolute',
                top: 0,
                left: 0,
                right: 0,
                ...
                <div className="hummer-spinner" style={{
                  width: '50px',
                  height: '50px',
            ...
            <div 
              ...
              style={{ 
                width: '100%', 
                height: '100%',
                visibility: formLoaded ? 'visible' : 'hidden'
              }}
            ></div>
          </motion.div>
        </div>
      ...
      <style jsx>{`
        ...
        .hummer-contact-header {
          margin-bottom: 3rem;
        }

        .hummer-contact-subtitle {
        ...
        .hummer-info-icon svg {
          width: 24px;
          height: 24px;
        }

        .hummer-info-content h4 {
          font-size: 1.2rem;
          margin-bottom: 0.5rem;
        }

        .hummer-info-content p {
          font-size: 0.95rem;
          line-height: 1.6;
          margin: 0.25rem 0;
        }
